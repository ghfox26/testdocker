...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/user_manager/testData/">员工列表</a></li>
		<li class="active"><a href="${ctx}/user_manager/testData/form?id=${testData.id}">员工<shiro:hasPermission name="user_manager:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="user_manager:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/user_manager/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="user_manager:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
